...
const ambassadors: AmbassadorData = {
  ...
  subAmbassadors: [
    { id: "ECSA-001-001", name: "Rita",     school: "Edwin Clark", percentage: 7, coreId: "ECCA-001", status: "active" },
    { id: "ECSA-001-002", name: "Praise",   school: "SDU",         percentage: 7, coreId: "ECCA-001", status: "active" },
    { id: "ECSA-001-003", name: "Queensly", school: "EUI",         percentage: 7, coreId: "ECCA-001", status: "active" },
  ],
};
